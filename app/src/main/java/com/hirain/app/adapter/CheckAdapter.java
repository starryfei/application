...
public class CheckAdapter extends BaseAdapter {
    ...
    public CheckAdapter(List<Mode> list, Context context){
        channelList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(mode != null){
            ...
            switch (position){
                case 0:
                    holder.imgChannel.setImageResource(R.mipmap.check0);
                    break;
                case 1:
                    holder.imgChannel.setImageResource(R.mipmap.check3);
                    break;
                case 2:
                    holder.imgChannel.setImageResource(R.mipmap.check4);
                    break;
                case 3:
